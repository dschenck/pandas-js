...
export default function (values) {
    ...
    return values.reduce((acc, curr, i) => {
        ...
        if (utils.isNaN(acc.loss) || (curr / cummax[i].value - 1) < acc.loss) {
        ...
        return acc
    }, { loss: 0, peak: undefined, trough: undefined, recovery: undefined, open: undefined, close: undefined })
}